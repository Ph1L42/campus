...
public class SampledFileTest {
    ...
    public void testPlayPauseStop() {
        ...
        // Now, start our test
        String formattedPositionInitial = f1.getFormattedPosition();
        // Start playing f1
        new Thread() {
            public void run() {
                try {
        ...
        String formattedPositionEnd = f1.getFormattedPosition();
